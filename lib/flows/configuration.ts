...
export function buildFlowFormPayload(input: { flowId?: string; name: string; periodType: string; targetType: FlowTargetType; manualTargetAmount: string; isActive?: boolean }) {
